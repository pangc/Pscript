...
static const yytype_uint8 yyrline[] =
{
      ...
      80,    81,    87,    97,    98,   102,   106,   110,   111,   115,
     116,   120,   121,   125,   126,   127,   131,   142
};
#endif
...
#line 143 "string.y"
    {
           (yyval.symbol) = new SymDesc (MakeName(), STR_CONST, (yyvsp[(1) - (1)].str), lineno);
           st.Add ((yyval.symbol));
        }
    break;
